class OenologistsController < ApplicationController
  ...
  def create
    @oenologist = Oenologist.new(name: oenologist_params[:name], age: oenologist_params[:age] , country: oenologist_params[:country])
  ...
  private
    ...
    def oenologist_params
      params.require(:oenologist).permit(:name, :age, :country, magazine_ids:[], positions:[])
    end
end
